### Character Progression - Giving him character - Editor
- First, show him facing depending on the direction
- What is a progression: Circular list
- What a bidirectional progression would look like it
- YAGNI
- Replace chars with progressions
...
class Pacman():
    ...
    def move(self, direction):
        self.disappear()
        # self.char = self.progression.get(direction.__name__)
